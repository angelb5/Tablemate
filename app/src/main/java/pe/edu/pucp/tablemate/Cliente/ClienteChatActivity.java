...
public class ClienteChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (reserva.getEstado().equals("Cancelada")) finalizada = true;
        LocalDateTime localDateTime = LocalDateTime.of(LocalDate.parse(reserva.getFecha(), dateFormatter), LocalTime.parse(reserva.getHora(), timeFormatter));
        Log.d("msg", localDateTime.toString());
        if (localDateTime.isBefore(LocalDateTime.now())) finalizada = true;
        ...
        tvFechaReserva.setText(reserva.getFecha()+" "+reserva.getHora().toUpperCase(Locale.ROOT).replace(" ",""));
    ...
    public void enviarMensaje(View view){
        ...
        chatRef.update("messages", FieldValue.arrayUnion(mensaje));
        etMensaje.setText("");
    }
}